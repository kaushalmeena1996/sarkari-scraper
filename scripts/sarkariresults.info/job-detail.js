...
function scrapJobDetail(html, url) {
  ...
  // Extract Table 1
  arr1 = $("div.pageContent > table > tbody > tr > td > div > h2 > table > tbody > tr > td > div:nth-child(1) > table > tbody > tr > td:nth-child(1) > div > table > tbody > tr > td > div > table > tbody > tr > td > div > table > tbody > tr > td > div table").eq(0).find("tr").toArray();
  ...
  // Extract Table 2
  arr1 = $("div.pageContent > table > tbody > tr > td > div > h2 > table > tbody > tr > td > div:nth-child(1) > table > tbody > tr > td:nth-child(1) > div > table > tbody > tr > td > div > table > tbody > tr > td > div > table > tbody > tr > td > div table").eq(1).find("tr").toArray();
  for (i = 0; i < arr1.length; i++) {
    if (isTable($, arr1[i])) {
